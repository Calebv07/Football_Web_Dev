...
class __TwigTemplate_af887515387cd9cf6c03105c75a44255d2c197d360a523d5653c0d7d1663f5d1 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Two-factor authentication is available, but not configured for this account.");
        ...
        ";
                ...
                // line 24
                echo "        ";
                if ((1 === twig_compare(twig_length_filter($this->env, ($context["missing"] ?? null)), 0))) {
                    // line 25
                    echo "          <p>
            ";
                    // line 26
...
echo _gettext("You have enabled two factor authentication.");
      ...
      ";
            // line 54
            if ((0 === twig_compare(($context["backend_id"] ?? null), "key"))) {
                // line 55
...
echo _gettext("Configure two-factor authentication");
      ...
      <form method=\"post\" action=\"";
        ...
        ";
            ...
            <p>";
                // line 88
                if ((0 === twig_compare((($__internal_compile_3 = $context["backend"]) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3["id"] ?? null) : null), "key"))) {
                    // line 89
...
";
    ...
    {
        return new Source("", "preferences/two_factor/main.twig", "/var/www/html/phpMyAdmin/templates/preferences/two_factor/main.twig");
    }
}
